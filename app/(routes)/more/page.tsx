...
export type RecentBooksT = Pick<Book, 'id' | 'cover_url' | 'author' | 'title'>[];
...
const MorePage = async () => {
	...
	const recentBooks = await prisma.book.findMany({
		...
		select: { id: true, cover_url: true, author: true, title: true },
	});
	return (
		<section className='px-4 py-2 pb-16'>
			<div className='flex items-center justify-between mb-2'>
				<h1 className='text-center text-lg font-semibold text-neutral-700 mb-3'>Профіль</h1>
				<LuSettings size={20} />
			</div>
			...
			<div className='mt-4 w-full flex justify-between items-center p-2 rounded-xl border-2 border-[#e7e7e734] shadow-sm [&_p]:text-sm [&_p]:text-neutral-700 [&_p]:tracking-tight [&_p]:font-medium'>
